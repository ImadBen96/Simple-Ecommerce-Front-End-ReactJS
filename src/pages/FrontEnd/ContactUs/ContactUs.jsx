...
function ContactUs() {
    const submitContact = (e) =>  {
        e.preventDefault();
        message.success("Your Message Is Send With Success");
    }
    return (
        <div className="contact-us">
            ...
            <div className="page-header">
                <h1>We are happy to assist you</h1>
                <p>Here to help, anytime you need us.</p>
            </div>
            ...
            <div className="info-cards">
                <div className="info-card">
                    ...
                    <div className="ic-value">support@example.com</div>
                </div>
                <div className="info-card">
                    <div className="ic-icon">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                    ...
                    <div className="ic-value">+1 (555) 123-4567</div>
                </div>
                <div className="info-card">
                    <div className="ic-icon">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                    ...
                    <div className="ic-value">123 Innovation Street, Suite 456, San Francisco, CA 94107, USA</div>
                </div>
                <div className="info-card">
                    <div className="ic-icon">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                    ...
                    <div className="ic-label">Website</div>
                    <div className="ic-value">www.imadgannoun.com</div>
                </div>
            </div>

            <div className="green-section">
                <div className="green-top">
                    <div className="gt-side"></div>
                    <div className="gt-center"></div>
                    <div className="gt-side"></div>
                </div>
                ...
                <form onSubmit={ submitContact }>
                    <div className="form-card">
                        ...
                        <div className="form-row">
                            <div className="form-group full"><input type="text" placeholder="Subject" /></div>
                        </div>
                        <div className="form-row">
                            <div className="form-group full"><textarea placeholder="Write your message"></textarea></div>
                        </div>
            ...
            {/*    <form onSubmit={ submitContact }>*/}
            {/*        <h1 classNameName="title text-center mb-4">Talk to Us</h1>*/}

            {/*        <div style={{marginBottom: "14px"}} classNameName="form-group position-relative">*/}
            {/*            <label htmlFor="formName" classNameName="d-block">*/}
            {/*                <i classNameName="icon" data-feather="user"></i>*/}
            {/*            </label>*/}
            {/*            <input type="text" id="formName" classNameName="form-control form-control-lg thick"*/}
            {/*                   placeholder="Name"/>*/}
            {/*        </div>*/}

            {/*        <div style={{marginBottom: "14px"}} classNameName="form-group position-relative">*/}
            {/*            <label htmlFor="formEmail" classNameName="d-block">*/}
            {/*                <i classNameName="icon" data-feather="mail"></i>*/}
            {/*            </label>*/}
            {/*            <input type="email" id="formEmail" classNameName="form-control form-control-lg thick"*/}
            {/*                   placeholder="E-mail"/>*/}
            {/*        </div>*/}

            {/*        <div style={{marginBottom: "14px"}} classNameName="form-group message">*/}
            {/*            <textarea id="formMessage" classNameName="form-control form-control-lg" rows="7"*/}
            {/*                      placeholder="Message"></textarea>*/}
            {/*        </div>*/}

            {/*        <div classNameName="text-center">*/}
            {/*            <button type="submit" classNameName="btn btn-primary" tabIndex="-1">Send message</button>*/}
            {/*        </div>*/}
            {/*    </form>*/}
